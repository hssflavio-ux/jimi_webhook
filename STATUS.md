...
> **Última atualização**: 23/07/2026 — **Sessão de 2 fixes, ambos commitados/pushados/deployados no homolog (servidor em `HEAD=88a98e1`, `origin/main=88a98e1`, working tree limpo).**
