...
> Entradas anteriores a "v4.9.32 — a trava do `UPDATE` desligava a atualização de 5 dos 6 modelos" (a partir de "📍 ESTADO EM 20/08/2026") arquivadas em docs/status-history/STATUS_ARCHIVE.md.
