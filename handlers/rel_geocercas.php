...
<div class="table-wrap">
    <table>
        ...
        <tbody>
            <?php if (empty($rows)): ?>
            <tr><td colspan="6"><div class="empty-state"><p>Nenhuma permanência no período.</p></div></td></tr>
...
<div class="table-wrap">
    <table>
        ...
        <tbody>
            <?php if (empty($rows)): ?>
            <tr><td colspan="6"><div class="empty-state"><p>Nenhum evento de geocerca no período.</p></div></td></tr>
            <?php else: foreach ($rows as $r): ?>
            <tr>
                <td class="text-mono"><?= fmt_brt($r['event_time'], 'd/m/Y H:i:s') ?></td>
                <td>
