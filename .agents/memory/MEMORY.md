...
- [project] Estado 29/07/2026: código em **v4.5.0** (`16f3184`, local = GitHub); **homolog ainda em `92725cb` / banco 4.4.1 — v4.5.0 NÃO publicada**. v4.4.0 motor de notificações (sino/pop-up/som/e-mail, `/config-notificacoes`), v4.4.1 SMTP cadastrável (`/config-smtp`, senha AES-256-GCM), v4.5.0 geocercas (`/geocercas`, `/relatorios/geocercas`, worker de 2 min). Roadmap: `docs/PLANO_IMPLEMENTACAO_v4.4-v4.7.md` — Fases 1–2 feitas, próxima é a **Fase 3 (v4.6.0, relatórios operacionais)**; Fase 5 (wiki) só ao fim de tudo → project-conventions.md
