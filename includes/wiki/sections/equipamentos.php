...
<tr><td>Importar em Lote</td><td>Envie um arquivo CSV com as colunas <strong>IMEI, Nome, Modelo, Canais, Firmware</strong> (a primeira linha é o cabeçalho e é ignorada). Administrador e revendedor escolhem o cliente, e todos os equipamentos do arquivo vão para ele. Ao terminar, a tela mostra "Importação concluída" e recarrega a lista. Linhas com IMEI inválido (fora de 15 a 17 dígitos) ou já cadastrado são ignoradas, e a tela <strong>não lista quais</strong> — confira na lista se todos entraram. Modelo desconhecido entra sem modelo</td></tr>
